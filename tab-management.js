...
class TabManagement {
    ...
    applyBuilderStyling() {
        ...
        const targetContainerSize = targetGridSize + mapContainerPadding;
        ...
        console.log('Builder styling - targetGridSize:', targetGridSize, 'containerSize:', targetContainerSize, 'sidebarWidth:', sidebarWidth);
